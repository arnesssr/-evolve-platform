...
from App.admin import base_views as views
...
urlpatterns = [
    ...
    # Main dashboard - use new modular view
    path('', dashboard_view, name='dashboard'),
    path('dashboard/', include('App.admin.urls.dashboard')),

    # Modular admin sections (only include existing ones)
    path('admins/', include(('App.admin.urls.admins', 'admin_admins'), namespace='admin_admins')),
    
    # Existing resellers (keep existing functionality)
    path('resellers/', include('App.admin.urls.resellers')),

    # Legacy routes (backward compatibility - can be removed later)
