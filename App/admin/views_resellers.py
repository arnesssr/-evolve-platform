...
# If there is a dedicated AdminRequiredMixin, import; otherwise, use LoginRequired only
try:
    from App.admin.permissions import AdminRequiredMixin  # type: ignore
except Exception:  # pragma: no cover
    class AdminRequiredMixin:  # fallback no-op mixin
        pass
