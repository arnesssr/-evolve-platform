...
urlpatterns = [
    ...
    path('ipn/register-current/', views.register_current_ipn, name='register_current_ipn'),
...
path('business-billing/', views.business_billing, name='business-billing'),
    ...
    path('business-billing/invoice/<str:order_id>/download/', views.business_invoice_download, name='business-invoice-download'),
